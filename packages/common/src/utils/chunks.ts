...
const splitBeforeWords = new Set([
  ...
  // --- Korean Conjunctions & Determiners ---
  "그리고",
  "하지만",
  "그러나",
  "그렇지만",
  ...
  // --- Spanish Conjunctions, Articles & Prepositions ---
  "y",
  "o",
  "pero",
  "porque",
  ...
  // --- French Conjunctions, Articles & Prepositions ---
  "et",
  "ou",
  "mais",
  "parce",
  ...
  // --- German Conjunctions, Articles & Prepositions ---
  "und",
  "aber",
  "oder",
  "weil",
  ...
  // --- Italian Conjunctions, Articles & Prepositions ---
  "e",
  "ma",
  "perché",
  "quindi",
