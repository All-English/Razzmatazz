    ...
    return (
      <div key={node.path}>
        ...
        >
          ...
          >
            <Folder
              className={`size-4 shrink-0 ${isSelected ? "text-primary" : "text-gray-500 dark:text-zinc-400"}`}
            />
            ...
            {openMenuFolder === node.path && (
              ...
              >
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-xs text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20"
                >
    ...
    <div className="hidden lg:flex h-full w-[240px] shrink-0 flex-col justify-between border-r border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4 select-none">
      <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto pr-1">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          >
            <FolderOpen
              className={`size-4 shrink-0 ${selectedFolder === "all" ? "text-primary" : "text-gray-500 dark:text-zinc-400"}`}
            />
          ...
          >
            <FolderHeart
              className={`size-4 shrink-0 ${selectedFolder === "favorites" ? "text-primary" : "text-gray-500 dark:text-zinc-400"}`}
            />
      ...
      <div className="mt-4 shrink-0 border-t border-gray-200/60 dark:border-zinc-800 pt-4">
        ...
        >
          <Trash2
            className={`size-4 shrink-0 ${selectedFolder === "trash" ? "text-red-500" : "text-gray-500 dark:text-zinc-400"}`}
          />
